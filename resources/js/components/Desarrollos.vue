                            ...
                            <table class="table table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    <tr v-for="desarrollo in arrayDesarrollo" :key="desarrollo.id">
                                        <td>
                                            <button type="button" @click="verDesarrollo(desarrollo.id)" class="btn btn-success btn-sm">
                                            <i class="icon-eye"></i>
                                            </button> &nbsp;
                                            <template v-if="desarrollo.estado=='Registrado'">
                                                <button type="button" class="btn btn-danger btn-sm" @click="desactivarVenta(desarrollo.id)">
                                        ...
                                        <td v-text="desarrollo.estado"></td>
                                    </tr>                                
                                </tbody>
                            </table>
                        </div>
