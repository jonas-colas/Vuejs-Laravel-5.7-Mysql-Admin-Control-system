      ...
      <div class="card">
        <template v-if="listado==1">
          <div class="card-header bg-dark">
            ...
            <!-- <button type ="button" @click="mostrarDatosPrincipal('desarrollo', desarrollo)" class="btn btn-warning">
              <i class="fa fa-pencil"></i>&nbsp;Editar el desarrollo
            </button> -->
          </div>
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped">
                ...
                <tr>
                  <th></th>
                  <td>
                    <button class="btn btn-warning btn-block" v-model="desarrollo_id"  @click="editarDesarrollo(desarrollo_id)"> <i class="fa fa-pencil"></i> editar Desarrollo</button>
                  </td>
                </tr>
              </tbody>
            </table>
...
<script>
  export default {
    ...
    methods : {
      ...
      mostrarDatosPrincipal(modelo, accion, data = []){
        switch(modelo)
        {
          case "desarrollo":
          {
