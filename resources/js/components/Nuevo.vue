...
<template>
  <main class="main">
    ...
    <div class="container-fluid">
      <template v-if="listado==0"> <!-- listado 0 son los datos principales -->
        <div class="card">
      ...
      <!-- listado 3 son las caracteristicas -->
      ...
      <template v-if="listado==5"> <!-- listado 5 son las fotos -->
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-header bg-dark text-white">Subir las fotos del Desarrollo</div>
                    <div class="card-body">
                       <div class="row">
                        <form @submit="uploadImage" enctype="multipart/form-data">
                          <div class="col-md-9" style="background-image:url('./img/building.png')">
                            <img class="img-responsive" :src="avatar"  height="320" width="290" >
                           </div>
                           <br>
                          <div class="col-md-9">
                          ...
                          <br>
                          <div class="col-md-9">
                             <button class="btn btn-success btn-block">Subir Foto</button>
                          </div>
                        </form>
                      </div>
                    </div>
...
<script>
    export default {
        ...
        methods : {
            ...
            getImage(e){
              let foto = e.target.files[0] || e.dataTransfer.files;
