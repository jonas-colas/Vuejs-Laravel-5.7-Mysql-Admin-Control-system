                ...
                <div class="card">
                    <template v-if="listado==1" >
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody v-for="desarrollo in arrayDetalle" :key="desarrollo.id">
                                    ...
                                    <!-- <tr>
                                        <th scope="row">Foto Principal :</th>
                                        <td><img v-bind:src="'Fotos/'+desarrollo.foto_1" class="img-responsive" height="50" width="50"></td>
                                    </tr>  
                                    <tr>
                                        <th scope="row">Foto Section :</th>
                                        <td><img v-bind:src="'Fotos/'+desarrollo.foto_section" class="img-responsive" height="50" width="50"></td>
                                    </tr>  -->
                                    <tr>
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="card-header bg-dark">
                            <button type="button" @click="abrirModal('caracteristica','registrar',caracteristica)" class="btn btn-primary btn-sm">Agregar Nueva Caracteristica <i class="icon-plus"></i> </button>
                            </div>
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
    ...
    export default {
        ...
        methods : {
            listarDesarrollo (page,buscar,criterio){
                ...
                var url= '/todosLosDesarrollos?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
                    ...
                    case "caracteristica":
                    {
                        switch(accion){
                            ...
                            case 'actualizar':
                            {
                               /* console.log(data);
                                console.log(data['id']);
                                console.log(data['id_desarrollo']);*/
